### Comparison operators {#comparison\_operators}
...
### IS DISTINCT FROM and IS NOT DISTINCT FROM {#is\_distinct\_operator}
...
### Quantified comparison predicates: ALL, ANY and SOME {#quantified\_comparison\_predicates}
